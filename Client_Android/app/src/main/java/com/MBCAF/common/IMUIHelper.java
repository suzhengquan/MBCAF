...
import com.MBCAF.common.pinyin.PinYin.PinYinElement;
...
public class IMUIHelper
{
    ...
    public static void openChatActivity(Context ctx, String sessionKey) {
        ...
        intent.putExtra(PreDefine.KEY_SESSION_KEY, sessionKey);
    ...
    public static void openUserProfileActivity(Context ctx, int contactId) {
        ...
        intent.putExtra(PreDefine.KEY_PEERID, contactId);
        ctx.startActivity(intent);
    }
    ...
    public static void showCustomDialog(Context context,int visibale,String title, final dialogCallback callback)
    {
        ...
        builder.setPositiveButton(context.getString(R.string.t047), new DialogInterface.OnClickListener() {
        ...
        builder.setNegativeButton(context.getString(R.string.t046), new DialogInterface.OnClickListener() {
            @Override
    ...
    public static String getRealAvatarUrl(String avatarUrl) {
        if (avatarUrl.toLowerCase().contains("http")) {
            ...
            return PreDefine.AVATAR_URL_PREFIX + avatarUrl;
        }
    }
