...
public class FileIOTools {
	...
	public static final String BASE_PATH = Environment.getExternalStorageDirectory() + "/gsgs/";
	/*日志　文件*/
...
//		MGUtils utils = MGUtils.instance(mCtx);
		...
		imgName = CalcUtil.instance().toMD5(imgName);
	...
	public void writeBtimapToSD(
		...
		String path = dir + CalcUtil.instance().toMD5(file);
	...
	public void delFilesByTime(final String dir, final int days){
		if(!isSDCardExist()||isDeletingFiles){
			return;
		}
