...
package com.MBCAF.app.ui.helper;
...
import com.MBCAF.app.audio.SpeexEncoder;
...
public class AudioRecordHandler implements Runnable {
        ...
        try {
            ...
            try {
                ...
                while (this.isRecording) {
                    ...
                    if (recordTime >= PreDefine.MAX_SOUND_RECORD_TIME) {
                        MessageActivity.getUiHandler().sendEmptyMessage(
                                PreDefine.RECORD_AUDIO_TOO_LONG);
                        break;
                    }
    ...
    private void setMaxVolume(short[] buffer, int readLen) {
        try {
            ...
            Msg.what = PreDefine.RECEIVE_MAX_VOLUME;
            Msg.obj = max;
