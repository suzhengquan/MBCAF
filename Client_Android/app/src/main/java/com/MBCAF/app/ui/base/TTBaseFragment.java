...
import com.MBCAF.R;
import com.MBCAF.app.ui.activity.SearchActivity;
import com.MBCAF.common.Logger;
import com.MBCAF.app.ui.widget.SearchEditText;
import com.MBCAF.app.ui.widget.TopTabButton;
...
public abstract class TTBaseFragment extends Fragment {
    ...
    protected void hideTopBar()
    {
        ...
        linearParams.height = SysUtil.instance(getActivity()).dip2px(45);
        topContactFrame.setLayoutParams(linearParams);
        topContactFrame.setPadding(0,SysUtil.instance(getActivity()).dip2px(10),0,0);
    }
