...
import com.MBCAF.app.ui.widget.IMGroupAvatar;
...
public class ChatAdapter extends BaseAdapter {
    ...
    public void updateRecentInfoByShield(GroupEntity entity){
        ...
        for(RecentInfo recentInfo:recentSessionList){
            if(recentInfo.getSessionKey().equals(sessionKey)){
                ...
                boolean isFor = status==PreDefine.Group_State_Shield;
    ...
    public int getItemViewType(int position) {
        try {
            ...
            }else if(recentInfo.getSessionType()==PreDefine.ST_Group){
    ...
    private void handleCommonContact(ContactViewHolder contactViewHolder,RecentInfo recentInfo)
    {
        ...
        String lastTime = "";
        int unReadCount = 0;
        int sessionType = PreDefine.ST_Single;
...
//        sessionType = recentInfo.getSessionType();
        ...
        if (unReadCount > 0) {
            if(recentInfo.isForbidden())
            {
                ...
                ((RelativeLayout.LayoutParams)groupViewHolder.msgCount.getLayoutParams()).leftMargin=SysUtil.instance(this.mInflater.getContext()).dip2px(-7);
                ((RelativeLayout.LayoutParams)groupViewHolder.msgCount.getLayoutParams()).topMargin=SysUtil.instance(this.mInflater.getContext()).dip2px(6);
                groupViewHolder.msgCount.getLayoutParams().width = SysUtil.instance(this.mInflater.getContext()).dip2px(10);
                groupViewHolder.msgCount.getLayoutParams().height = SysUtil.instance(this.mInflater.getContext()).dip2px(10);
            ...
            else
            {
                ...
                groupViewHolder.msgCount.setVisibility(View.VISIBLE);
                ((RelativeLayout.LayoutParams)groupViewHolder.msgCount.getLayoutParams()).leftMargin=SysUtil.instance(this.mInflater.getContext()).dip2px(-10);
                ((RelativeLayout.LayoutParams)groupViewHolder.msgCount.getLayoutParams()).topMargin=SysUtil.instance(this.mInflater.getContext()).dip2px(3);
                ...
                groupViewHolder.msgCount.setPadding(SysUtil.instance(this.mInflater.getContext()).dip2px(3),0,SysUtil.instance(this.mInflater.getContext()).dip2px(3),0);
    ...
    private void setGroupAvatar(GroupViewHolder holder,List<String> avatarUrlList){
        ...
        if (null == avatarUrlList) {
            ...
            holder.avatarLayout.setAvatarUrlAppend(PreDefine.AVATAR_APPEND_32);
