...
public class TopTabButton extends FrameLayout {
    ...
    private void initView() {
        ...
        // tabDepartmentBtn.setText(context.getString(R.string.t057));
        ...
        tabDepartmentBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                message.what=PreDefine.HANDLER_CHANGE_CONTACT_TAB;
                message.obj = 1;
        ...
        // tabALLBtn.setText(context.getString(R.string.t056));
