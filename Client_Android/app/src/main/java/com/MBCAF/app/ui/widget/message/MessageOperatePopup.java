...
public class MessageOperatePopup implements View.OnClickListener, View.OnTouchListener {
    ...
    public void show(View item, int type, boolean bResend, boolean bSelf) {
        ...
        if (bResend && bSelf) {
            ...
            bresendShow = true;
            if (type == PreDefine.View_Text_Type) {
            ...
            bresendShow = false;
            if (type != PreDefine.View_Image_Type && type != PreDefine.View_Audio_Type && type != PreDefine.View_AniImage_Type)  {
                copyBtn.setVisibility(View.VISIBLE);
                bcopyShow = true;
            } else {
                copyBtn.setVisibility(View.GONE);
