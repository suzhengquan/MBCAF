...
import com.MBCAF.R;
import com.MBCAF.app.ui.adapter.album.ImageGridAdapter;
import com.MBCAF.app.ui.adapter.album.ImageGridAdapter.TextCallback;
...
public class ImageGridActivity extends Activity implements OnTouchListener {
            ...
            switch (msg.what) {
                case 0:
                    Toast.makeText(ImageGridActivity.this,
                            "最多选择" + PreDefine.MAX_SELECT_IMAGE_COUNT + "张图片",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = (String) getIntent().getSerializableExtra(
                PreDefine.EXTRA_ALBUM_NAME);
        dataList = (List<ImageItem>) getIntent().getSerializableExtra(
                PreDefine.EXTRA_IMAGE_LIST);
        initView();
        initAdapter();
    }
        ...
        finish.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (adapter.getSelectMap().size() > 0) {
                    ...
                    Toast.makeText(ImageGridActivity.this,
                            R.string.t027, Toast.LENGTH_SHORT)
                            .show();
                }
            }
    ...
    public static void setSendText(int selNum) {
        if (selNum == 0) {
            finish.setText(context.getResources().getString(R.string.t044));
        } else {
            finish.setText(context.getResources().getString(R.string.t044)
                    + "(" + selNum + ")");
        }
