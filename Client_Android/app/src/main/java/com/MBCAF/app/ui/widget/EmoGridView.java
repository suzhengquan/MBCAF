...
import com.MBCAF.R;
import com.MBCAF.app.ui.adapter.EmoGridViewAdapter;
...
public class EmoGridView extends LinearLayout {
    ...
    private int[] getGridViewData(int index) {
        ++index;
        int startPos = (index - 1) * (PreDefine.pageSize - 1);
        int endPos = index * (PreDefine.pageSize - 1);
        int length = 0;
    ...
    private GridView getViewPagerItem(final int index) {
        ...
        gridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                int start = index * (PreDefine.pageSize - 1);
