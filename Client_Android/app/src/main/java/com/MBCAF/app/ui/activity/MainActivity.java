...
import com.MBCAF.app.ui.fragment.ContactFragment;
import com.MBCAF.app.network.IMServiceConnector;
import com.MBCAF.common.Logger;
import com.MBCAF.app.ui.widget.NaviTabButton;
...
public class MainActivity extends FragmentActivity{
	...
	private void initTab() {
		...
		mTabButtons[0].setTitle(getString(R.string.t002));
		...
		mTabButtons[1].setTitle(getString(R.string.t003));
		...
		mTabButtons[2].setTitle(getString(R.string.t004));
		...
		mTabButtons[3].setTitle(getString(R.string.t005));
	...
	private void handleLocateDepratment(Intent intent) {
		int departmentIdToLocate= intent.getIntExtra(PreDefine.KEY_LOCATE_DEPARTMENT,-1);
	...
	private void jumpToLoginPage() {
		...
		intent.putExtra(PreDefine.KEY_LOGIN_NOT_AUTO, true);
