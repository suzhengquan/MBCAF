...
import com.MBCAF.R;
import com.MBCAF.app.ui.adapter.ViewPageAdapter;
import com.MBCAF.app.ui.adapter.YayaEmoGridViewAdapter;
...
public class YayaEmoGridView extends LinearLayout {
    ...
    private int[] getGridViewData(int index) {
        ++index;
        int startPos = (index - 1) * PreDefine.yayaPageSize;
        int endPos = index * PreDefine.yayaPageSize - 1;
    ...
    private GridView getViewPagerItem(final int index) {
        ...
        gridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                int start = index * PreDefine.yayaPageSize;
